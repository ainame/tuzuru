...
public struct SourceLayout: Sendable, Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.templates = try container.decode(Templates.self, forKey: .templates)
        self.contents = FilePath(try container.decode(String.self, forKey: .contents))
        self.assets = FilePath(try container.decode(String.self, forKey: .assets))
    }
